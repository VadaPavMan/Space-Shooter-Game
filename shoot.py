...
class Bullet(arcade.Sprite):
    ...
    def off_screen(self, width, height):
        return (
            self.bullet.center_x < -10
            or self.bullet.center_x > width + 10
            or self.bullet.center_y < -10
            or self.bullet.center_y > height + 10
        )
...
class Enemy_Bullet_Dual(arcade.Sprite):
    ...
    def off_screen(self, width, height):
        return (
            self.bullet_right.center_x < -10
            or self.bullet_right.center_x > width + 10
            or self.bullet_right.center_y < -10
            or self.bullet_right.center_y > height + 10
        ) or (
            self.bullet_left.center_x < -10
            or self.bullet_left.center_x > width + 10
            or self.bullet_left.center_y < -10
            or self.bullet_left.center_y > height + 10
        )
